...
1. ### 2. Microphone & Analog Front-End Board
2. An acoustic front-end array designed to capture and amplify audio signals with minimal noise.
3. **Microphones:** Knowles FG-Series professional audio microphones.
*  **Preamplifier Stage:** OPA320 in a non-inverting configuration.
*  
3. **Microcontroller Board:** The processing unit responsible for sampling the audio data, executing the TDOA mathematical model, and determining the localization vector.
